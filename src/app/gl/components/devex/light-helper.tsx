...
export const CameraHelper = ({ camera }: CameraHelperProps) => {
  ...
  useFrame(() => {
    if (
      ...
      !arrayEquals(camera.rotation.toArray(), refs.current.rotation.toArray()) ||
